-- Wave 1: additive project profile fields
...
-- AI suggested project fields (require explicit human acceptance)
...
-- Data sources / connection registry per project
