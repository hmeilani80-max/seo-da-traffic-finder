  ...
  head: () => ({
    meta: [
      { title: "Test Search Volume Apify" },
      {
        name: "description",
        content:
          "Test satu keyword dari tabel Sudah Dibeli menggunakan Apify tanpa menyimpan hasil.",
      },
    ],
  }),
    ...
    <div className="mx-auto max-w-4xl space-y-4 px-4 py-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Mengetes satu row Sudah Dibeli menggunakan actor burbn/ahrefs-keyword-explorer. Hasil test
